...
local current_variant = variants.moon

theme.font = "Fira Sans 11"

theme.bg_normal = current_variant.base
theme.bg_focus = current_variant.highlight_med
theme.bg_urgent = current_variant.rose
theme.bg_minimize = theme.bg_normal
theme.bg_systray = theme.bg_normal

theme.fg_normal = current_variant.text
theme.fg_focus = current_variant.gold
theme.fg_urgent = current_variant.love
